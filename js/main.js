...
(function () {
    ...
    function runInitialIgnition() {
        ...
        setTimeout(() => {
            ...
            // Failsafe: ignite home after 2 seconds regardless
            setTimeout(triggerIgnite, 2000);
        }, 700);
    }
    ...
    function performTransition(targetPage, originElement) {
        ...
        setTimeout(() => {
            ...
            if (ignited[targetPage]) {
                ...
                // Defensive: if the axon's onContact never fires
                // (e.g., the axon is somehow lost), force-ignite the
                // page after a generous timeout so the visitor never
                // ends up on a permanently-dark page.
                let igniteTriggered = false;
                const triggerIgnite = () => {
                    if (igniteTriggered) return;
                    igniteTriggered = true;
                ...
                // Failsafe: if the contact callback hasn't fired
                // within 1.5 seconds, ignite anyway
                setTimeout(triggerIgnite, 1500);
            }
        }, 1850);
    }
